...
def get_model(model_name, num_class, modality = 'fusion'):
...
def run_train(config):
    ...
    net = get_model(model_name=config.model, num_class=2,modality=config.image_mode)
    # print(net)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--image_mode', type=str, default='color')  # default = 'fusion
    # batch_size最小是36，因为验证集中的batch_size = config.batch_size//36
